...
Besides the documentations in the code there is a compiled version
generated by doxygen [here](http://openlima.robertboehm.net/).

I try to keep it updated, but it maybe not always be up-to-date. If
you want, you can compile your own documentation using [doxygen](http://www.doxygen.org/).
